...
export async function generateRagAnswer(
  ...
  try {
    ...
    const systemPrompt = `You are a helpful financial advisor named WealthIn. Your user is an entrepreneur in India.
Use the provided transaction history to give a concise, relevant, and actionable answer to the user's query.
